...
public class UCMovieAdapter extends RecyclerView.Adapter<UCMovieAdapter.Holder> {
    ...
    @Inject
    public UCMovieAdapter(Context context, Picasso picasso) {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (UCMovieAdapter.this.mOnItemClickListener != null) {
                    ImageView imageView = (ImageView) v.findViewById(R.id.movie_icon);
                    UCMovieAdapter.this.mOnItemClickListener.onMovieItemClicked(movie, imageView);
                }
            }
        });
    }
