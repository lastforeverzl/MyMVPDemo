...
public class WLMovieAdapter extends RecyclerView.Adapter<WLMovieAdapter.Holder> {
    ...
    @Inject
    public WLMovieAdapter(Context context, Picasso picasso) {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (WLMovieAdapter.this.mOnItemClickListener != null) {
                    ImageView imageView = (ImageView) v.findViewById(R.id.movie_icon);
                    WLMovieAdapter.this.mOnItemClickListener.onMovieItemClicked(movie, imageView);
                }
            }
        });
    }
