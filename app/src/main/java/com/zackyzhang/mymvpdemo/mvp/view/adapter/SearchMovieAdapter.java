...
public class SearchMovieAdapter extends RecyclerView.Adapter<SearchMovieAdapter.Holder> {
    ...
    @Inject
    public SearchMovieAdapter(Context context, Picasso picasso) {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (SearchMovieAdapter.this.mOnItemClickListener != null) {
                    ImageView imageView = (ImageView) v.findViewById(R.id.movie_icon);
                    SearchMovieAdapter.this.mOnItemClickListener.onMovieItemClicked(movie, imageView);
                }
            }
        });
    }
